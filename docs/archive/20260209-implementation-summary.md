...
**File:** `FlowForge/ContentView.swift`
...
**File:** `FlowForge/Models/AppState.swift`
...
**File:** `FlowForge/Views/SettingsView.swift`
...
1. **fullscreen-ui-update.md** - Comprehensive guide to new UI
2. **new-ui-mockup.md** - Visual mockups of each state
