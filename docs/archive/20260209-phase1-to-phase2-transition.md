...
1. **docs/archive/20260209-bugfix-state-loading.md** - Detailed bug analysis
2. **docs/archive/20260209-settings-ui-fixed.md** - UI improvements
3. **docs/archive/20260209-bugfix-summary.md** - Quick reference
