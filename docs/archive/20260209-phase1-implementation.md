...
- `FlowForge/ContentView.swift` - Complete refactor for real files
- `FlowForge/Models/AppState.swift` - NEW
- `FlowForge/Services/FolderManager.swift` - NEW
- `FlowForge/Views/SettingsView.swift` - NEW
